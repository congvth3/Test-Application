...
import helloworld.chcompany.vuthecong.travelapplication.adapter.FeedListAdapter;
...
public class NewFeed extends Activity {
    ...
    private String URL_FEED = "http://godou.16mb.com/test.json";

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.list_location_main);
